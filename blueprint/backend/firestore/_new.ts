...
export class NewFirestore {
    ...
    static getObjectReference(): FirebaseFirestore.CollectionReference<New> {
        return this.configDocRef().withConverter({
            toFirestore: (obj: New): FirebaseFirestore.DocumentData => obj.toMap(),
            fromFirestore: (
                snapshot: FirebaseFirestore.QueryDocumentSnapshot
            ): New => New.fromMap(snapshot.data()),
        });
    }

    static async get(docId: string): Promise<New | undefined> {
    ...
    static async insertBulk(objects: New[]): Promise<void> {
